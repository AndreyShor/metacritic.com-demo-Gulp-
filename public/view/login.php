			...
			<div class="input-cart col s12 m10 push-m1 z-depth-2 grey lighten-5">
				<div class="col s12 m5 login">
					...
					<form action="check.php" method="post" autocomplete="off">
						...
						<div class="row">
							...
							<div class="col s6">
								<button type="submit" name="login" class="btn waves-effect waves-light black right">Log
									in</button>
							</div>
						</div>
					</form>
				...
				<div class="col s12 m7 signup">
					<div class="signupForm">
						...
						<div class="row">
							<button type="submit" name="btn-signup" class="btn blue right waves-effect waves-light">Sign
								Up</button>
						</div>
					</div>
