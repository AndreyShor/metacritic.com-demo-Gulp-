...
<body>
  <header>
    <ul>
      ...
      <a href="./../public/view/admin.php"><li>Admin</li></a>
      <a href="./../public/view/login.php"><li>Login</li></a>
    </ul>
  </header>
   <div class="intro">
    ...
    <section>
        ...
        <article>
            ...
            <div class= "btn">
              <a href="./../public/view/art1.html" class="btn-1">
        ...
        <article>
            ...
            <div class= "btn">
              <a href="./../public/view/art2.html" class="btn-1">
                <span class="txt">More</span>
                <span class="round"><i class="fa fa-chevron-right"></i></span>
              </a>
            </div>
    ...
    <div class="btn_more">
      <a href="./../public/view/articles.html" class="btn-1">
